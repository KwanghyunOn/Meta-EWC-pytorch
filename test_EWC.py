...
if __name__ == "__main__":
    ...
    cfg = config.EWCLearnerConfig(float(args.lr), float(args.alpha), args.name)
    ...
    with result_path.open(mode='w') as fw:
        print(f"lr = {cfg.lr:.3f}, alpha = {cfg.alpha:.3f}, batch size = {cfg.batch_size}", file=fw)
